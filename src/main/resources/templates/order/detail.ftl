        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <#if orderDTO.getOrderStatusEnums().msg == "新订单">
                    <a href="/sell/seller/order/finish/${orderDTO.orderId}" type="button"
                    ...
                    <a href="/sell/seller/order/cancel/${orderDTO.orderId}" type="button"
                       class="btn btn-default btn-warning">
                        取消订单</a>
                <#else>
                    <a href="/sell/seller/order/list" type="button"
                       class="btn btn-default btn-info">该订单已经被取消或者完结，点我返回</a>
                </#if>
                </div>
            </div>
        </div>
